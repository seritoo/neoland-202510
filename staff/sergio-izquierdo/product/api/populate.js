...
database.connect('mongodb://localhost:27017/product')
    ...
    .then(hash => {
        const jack = new UserModel({ name: 'Jack Skellington', email: 'jack@halloween.com', username: 'Jack', password: hash })
        const sally = new UserModel({ name: 'Sally Skellington', email: 'sally@halloween.com', username: 'Sally', password: hash })
