const root = ReactDOM.createRoot(document.getElementById('root')) // crea un punto de montaje del DOM virtual para convertirlo a DOM real en el div. Solo se ha una vez para que react sepa donde pintar

root.render(<App />) // aquí se convierte a DOM real
