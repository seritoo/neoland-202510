...
function Trans(name, age, gender, operated) {
	Person.call(this, name, age, gender, operated)
...
var wendu = new Trans('Wendu', 22, 'female', false)
...
console.log('peter')
console.log('is wonan', wendy instanceof Woman) // false
console.log('is man', peter instanceof Man) // true
console.log('is person', peter instanceof Man) // true
